...
<template>
  <Teleport to="body">
    <div :class="`modal ${(!modalData || !modalData.active) && 'opacity-0 pointer-events-none'
      ...
      <div class="absolute w-full h-full bg-gray-900 opacity-50 modal-overlay" @click="toggleModal" />

      <div
        class="z-50 w-11/12 mx-auto overflow-y-auto bg-white dark:bg-gray-500 dark:text-gray-100 rounded shadow-lg max-h-full modal-container md:max-w-md">
        ...
        <div class="px-6 py-4 text-left modal-content">
          <div v-show="modalData && modalData.imageUrl" class="flex justify-center">
            <div
              ...
              <img class="object-cover w-auto h-auto" :src="modalData ? modalData.imageUrl : null" alt="Your avatar">
            </div>
          </div>
          <!-- Title -->
